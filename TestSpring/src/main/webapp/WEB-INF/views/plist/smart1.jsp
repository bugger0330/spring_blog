	...
	<div class="row justify-content-center" style="margin-top: 40px;">
		<div class="col-md-8 col-md-offset-3" id="ddd">
			<div class="input-group ">
				...
				<input class="form-control" id="search-con" name="keyword" value="" style="margin: 0px 12px 0px 0px;" placeholder="검색">
...
<br><br>
    ...
    <script src="/app/static/javascript/plist/smart1.js"></script>
